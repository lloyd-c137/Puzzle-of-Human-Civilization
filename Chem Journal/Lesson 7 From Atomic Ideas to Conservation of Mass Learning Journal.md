...
| Selected textbook or workbook exercises | Complete four Chapter 2 exercises and record the ratio, unit, system boundary, or reason. |
| One-page evidence chain | Connect atomos → Boyle → Lavoisier and state the open-system boundary. |
| Check Out Questions | Answer all three questions with a system, ratio, or composition explanation. |
