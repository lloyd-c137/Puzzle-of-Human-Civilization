...
journal_type: unit
subject: Chemistry
unit: Chemical Foundations and Liquid Type Test
---
...
### Learning entry — 2026-08-26 — Lesson 4 checkout questions
...
Chemistry — Significant figures, exact numbers, and rounding rules
...
I understood that leading zeros do not count as significant figures, but I was still unsure what happens to those zeros and why a final answer sometimes needs scientific notation. I also needed to separate the addition/subtraction rule from the multiplication/division rule and understand why an exact counted number does not limit the result.
...
Medium. I can follow and explain all three solutions, but I should reproduce them without notes to confirm mastery.

#### Progress

Applied — the three Checkout Questions are answered with the required rules, calculations, and corrections.
...
“这个怎么完成”。在学习过程中，我也曾把一个数字是否准确数和它的外观联系起来，而没有先判断它是定义、计数、测量还是近似值。

“**a是准确数 b非准确数 c不知道 d非准确数**”。这四个判断中有 3 个正确。
