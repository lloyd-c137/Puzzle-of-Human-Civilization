---
layout: default
title: Physics Chapter 3 Learning Journal
permalink: /physics/chapter-3-journal/
section: Physics
summary: Real-time learning record for Chapter 3 Linear Motion, including relative motion, speed, velocity, and acceleration.
journal_type: unit
subject: Physics
unit: Physics Foundations — Chapter 3 Linear Motion
---
...
At the highest point, the ball’s instantaneous velocity is (v=0), but gravity is still acting. If upward is positive, the acceleration remains (a=-gapprox-10\ \mathrm{m/s^2}). The ball’s velocity is changing from upward to downward, so its acceleration is not zero.
...
![My hand-drawn free-fall diagram](attachments/free-fall-hand-drawn.jpg)
...
3. **Q21. What is the distance fallen for a freely falling object 1 s after being dropped from a rest position? What is the distance for a 4-s drop?**
   ...
   **My answer:** After 1 s, the object has fallen \(10\ \mathrm{m}\); after 4 s, it has fallen \(40\ \mathrm{m}\).
   ...
   **Follow-up question:** Why is the distance after 1 s not (10\ \mathrm{m})?
   ...
   **Re-attempt:** After 1 s, I answered (5\ \mathrm{m}); after 4 s, I answered (20\ \mathrm{m}).
   ...
   **Final understanding:** I now understand that after 4 s the final speed is (40\ \mathrm{m/s}). Since the object accelerates uniformly from (0) to (40\ \mathrm{m/s}), its average speed is (20\ \mathrm{m/s}), so the displacement is (20\times4=80\ \mathrm{m}).
...
4. **Q22. What is the effect of air resistance on the acceleration of falling objects?**
   ...
   **My answer:** I thought that if air resistance acted in the same direction as the motion, the object would accelerate, and if it acted in the opposite direction, the object would decelerate. When air resistance equals gravity, I said the object reaches terminal velocity.
   ...
   **Follow-up question:** If the air force points in the same direction as the object’s motion, does air resistance not exist?
