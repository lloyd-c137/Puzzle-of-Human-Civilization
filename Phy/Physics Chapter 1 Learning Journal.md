---
layout: default
title: Physics Chapter 1 Learning Journal
permalink: /physics/chapter-1-journal/
section: Physics
summary: Real-time learning record for Physics Foundations and Chapter 1.
journal_type: unit
subject: Physics
unit: Physics Foundations — Chapter 1
---

# Physics Chapter 1 Learning Journal

## Unit purpose

This Unit Journal records the actual learning process for scientific thinking, measurement, astronomical scale, and testable explanations. The physics subject overview is maintained separately in [Physics Learning Journal]({{ '/physics/learning-journal/' | relative_url }}).

## Progress dashboard

| Topic | Status | Confidence | Last updated | Next step |
|---|---|---|---|---|
| Observation, measurement, and evidence | Exploring | Medium | 2026-08-20 | Complete a measurement and record uncertainty. |
| Astronomical scale and indirect measurement | Exploring | Medium | 2026-08-20 | Carry out the shadow measurement of Earth's circumference. |
| Testable scientific explanations | Partly understood | Medium | 2026-08-20 | State a prediction and identify evidence that could contradict it. |

## Key knowledge and vocabulary

| Concept or term | My current explanation | Example or connection | Status |
|---|---|---|---|
| Measurement | A quantitative observation made with a defined method and unit. | Shadow length can provide evidence about Earth's scale. | Exploring |
| Scientific explanation | A claim that makes testable predictions and can be challenged by evidence. | A plausible story is not sufficient by itself. | Partly understood |
| Uncertainty | The limits within which a measurement or conclusion may vary. | Timing, location, weather, and instrument precision affect the estimate. | Exploring |

## Learning entries

### Learning entry — 2026-08-20 — About science, measurement, and astronomical scale
